...
int main() {
	...
	for (int i = 0; i < 3; ++i)
		std::cout << "(" << i+1 << ")\t" << nnet::net86::constants::reaction_list[i] << "\t\tR=" << rate[i] << ",\tdR/dT=" << drates[i] << "\n";
	std::cout << "(3He -> C)\t" << nnet::net86::constants::reaction_list[3] << "\t\tR=" << rate[3] << ",\tdR/dT=" << drates[3] << "\n";
	std::cout << "(3He <- C)\t" << nnet::net86::constants::reaction_list[4] << "\t\tR=" << rate[4] << ",\tdR/dT=" << drates[4] << "\n";
	...
	for (int i = 157; i < 157 + (157 - 5); ++i)
		std::cout << "(" << i-(157 - 5)+1 << ")\t" << nnet::net86::constants::reaction_list[i] << "\t\tR=" << rate[i] << ",\tdR/dT=" << drates[i] << "\n";
}